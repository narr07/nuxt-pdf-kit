...
The `NuxtPdfKit` component provides several slots for customization.
 ...
 | `search-tool` | Custom search controls. |
 | `rotate-tool` | Custom rotate button. |
 | `open-file-tool` | Custom open file button. |
 | `print-tool` | Custom print button. |
 | `download-tool` | Custom download button. |
 | `fullscreen-tool` | Custom fullscreen button. |
 | `theme-toggle-tool` | Custom theme toggle button. |
 | `more-options-tool` | Custom more options button. |
