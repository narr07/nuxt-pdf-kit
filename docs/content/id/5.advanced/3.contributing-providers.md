...
Buat dokumentasi untuk penyedia kamu di `docs/content/en/5.advanced/2.providers.md`:
...
2. Klik "Share" (Bagikan) → "Copy link" (Salin tautan)
...
Kami sangat antusias melihat penyedia apa yang akan kamu tambahkan! 🚀
