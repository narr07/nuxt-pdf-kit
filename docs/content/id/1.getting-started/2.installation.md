...
* Mempelajari tentang [Props Komponen](/id/components/props) untuk menyesuaikan penampil
* Menjelajahi [Composables](/id/composables/overview) untuk kontrol programatik
* Memeriksa opsi [Module Options](/id/configuration/module-options) untuk konfigurasi global
